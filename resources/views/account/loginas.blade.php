        ...
        <div class="singup-body account-register">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-0 d-flex align-items-center justify-content-center bg-white bg-img-hero" style="background-image: url(/assets/img/crowdimg3.jpg);">
