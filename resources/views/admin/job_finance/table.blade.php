...
<table class="table table-striped table-bordered" id="finances-table" width="100%">
    ...
    <tbody>
     ...
     @foreach($finances as $finance)
        <tr>
            <td>{!! $a++ !!}</td>
            <td>{!! $finance->userjobs->jobdetail->job_title !!} </td>
            <td>{!! $finance->userjobs->fromuser->full_name !!}</td>
            <td>{!! $finance->userjobs->jobdetail->by_user_job->first_name !!} </td>
            ...
            <td>
                 <a href="{{ route('admin.job_finance.edit', $finance->job_order_id) }}">
