...
<div class="bg-red">
    <div class="px-5 py-2">
        <div class="align-items-center">
            ...
            <span class="h5 text-white ml-2">My Requirement</span>
        </div>
    </div>
</div>
@stop
    ...
    <table class="table table-striped" id="myrequirement-table">
        ...
        @foreach($leads as $lead)
            <tr>
                ...
                <td><a href="{{ route('my-requirement.view',$lead->staffing_leads_id) }}"><i class="fas fa-info-circle"></i></a></td>
            </tr>
        @endforeach
        </tbody>
    </table>
