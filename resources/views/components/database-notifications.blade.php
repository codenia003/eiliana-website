<div class="btn-group">
    <a class="nav-link notifications" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <i class="far fa-bell" aria-hidden="true"></i><span class="badge">{{Sentinel::getUser()->unreadNotifications->count()}}</span>
    </a>
    <div class="dropdown-menu dropdown-menu-right">
      ...
      <div class="list-group list-group-flush">
        @foreach (Sentinel::getUser()->notifications as $notification)
        <a href="{{ $notification->data['actionURL'] }}/{{ $notification->data['main_id'] }}" class="list-group-item">
