        ...
        <div class="bg-blue">
            ...
            <div class="card-body p-4">
                <form action="{{ route('contractual-job-inform.store') }}" method="POST" id="educationForm">
                    @csrf
                    <input type="hidden" name="project_leads_id" value="">
                    <div class="main-moudle">
                        <div class="form-row">
                            <div class="form-group col-6">
                                <label>Candidate Name</label>
                                <input type="text" class="form-control" name="candidate_name" value="" required="">
                            </div>
                            <div class="form-group col-6">
                                <label>Referral ID</label>
                               <input type="text" class="form-control" name="referral_id" value="" required="">
                            </div>
                        </div>
                        <div class="form-row">
