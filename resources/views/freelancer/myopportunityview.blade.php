...
<div class="bg-red">
    <div class="px-5 py-2">
        <div class="align-items-center">
            ...
            <span class="h5 text-white ml-2">My Opportunity : {{ $leads->fromuser->full_name }}</span>
        </div>
    </div>
</div>
@stop
            ...
            <form action="{{ url('/post-staffing-lead') }}" method="POST" id="staffingflead">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="lead-id" class="col-form-label">Opportunity Id:</label>
                        <input type="text" class="form-control" id="lead-id" name="leadid" value="{{ $leads->staffing_leads_id }}" readonly>
                    </div>
                    <div class="form-group">
