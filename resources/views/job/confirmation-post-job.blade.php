    ...
    <div class="bg-red">
        <div class="px-5 py-2">
            <div class="align-items-center">
                ...
                <span class="h5 text-white ml-2">Post Job</span>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ url('/post-job-on') }}" method="POST" id="postJobForm">
                            ...
                            <div class="skills mt-4">
                                ...
                                <p>{{ Session::get('post_job_data')['notice_period'] }}</p>
                            </div>
                            <div class="skills mt-4">
                                <span class="h5">Budget(Per Month)</span>
                                <p>{{ Session::get('post_job_data')['budget_from'] }} to {{ Session::get('post_job_data')['budget_to'] }}</p>
                            </div>
                            <div class="skills mt-4">
                                <span class="h5">Contract Duration</span>
                                <p>{{ Session::get('post_job_data')['contract_duration_from'] }} to {{ Session::get('post_job_data')['contract_duration_to'] }}</p>
                            </div>
                            <div class="skills mt-4">
                                <span class="h5">Total Experience</span>
                                <p>{{ Session::get('post_job_data')['experience_year'] }} Years {{ Session::get('post_job_data')['experience_month'] }} Month</p>
                            </div>
                            <div class="skills mt-4">
                                <span class="h5">Skills</span>
                                <p>{{ Session::get('post_job_data')['key_skills'] }}</p>
                            </div>
                            <hr>
                            ...
                            <div class="skills mt-4">
                                ...
                                @foreach ($locations as $location)
                                    @if(Session::get('post_job_data')['location']==$location->location_id)
