	             ...
	             <div class="singup-body login-body profile-basic">
					<div class="card">
						...
						<div class="card-body p-4">
                            <form action="{{ route('ProjectReviseProposal.new') }}" method="POST" id="projectlead" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col">
                                            ...
                                            <input type="number" class="form-control" name="bid_amount" id="bid_amount" value="{{ $project->bid_amount }}" required>
                                        </div>
                                        <div class="form-group col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="delivery_timeline" id="delivery_timeline" value="{{ $project->delivery_timeline }}" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="subject" id="subject" value="{{ $project->subject }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label">Message:</label>
                                        <textarea class="form-control" id="message-text" name="messagetext" rows="3" required>{{ $project->message }}</textarea>
                                    </div>
                                    ...
                                    <div class="singup-body float-right mt-3">
                                        <div class="btn-group" role="group">
                                            <button class="btn btn-primary" type="submit"><span class="spinner-border spinner-border-sm mr-1 d-none"></span> Send To Customer</button>
